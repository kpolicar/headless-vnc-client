 ...
 */
public class KpolicarMemoryImageSource implements ImageProducer {
    int width;
    int height;
    ColorModel model;
    Object pixels;
     ...
     */
    public KpolicarMemoryImageSource(int w, int h, ColorModel cm,
     ...
     */
    public KpolicarMemoryImageSource(int w, int h, int pix[], int off, int scan) {

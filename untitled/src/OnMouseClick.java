...
public class OnMouseClick implements HttpHandler {
    private final VncViewer viewer;

    public OnMouseClick(VncViewer v) {
        this.viewer = v;
    }
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        try {
            ...
            viewer.rfb.writePointerEvent(new MouseEvent(viewer,
                    ...
                    0,
                    isLeft ? MouseEvent.BUTTON1 : MouseEvent.BUTTON3_MASK | MouseEvent.META_MASK,
                    x,
                    y,
                    1,
                    false,
            ...
            System.out.println("Mouse click x:" +x+" y:" +y+" mouse:" +query.get("mouse"));
